...
async function testAI() {
  const payload = {
    ...
    callbackUrl: "http://localhost:5000/api/sessions/sess_71fd2016-645b-4749-88f9-559e06495e83/report",
    serviceToken: "7d291b5c4f69742a9b1c7e9a0c2b5d4e1f8e9a5c6d3b2a1f0e9d8c7b6a5f4e3d"
  };

  console.log("Sending payload to http://localhost:8000/process:\n", JSON.stringify(payload, null, 2));
