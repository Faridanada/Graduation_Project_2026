...
class _HomeContentState extends State<_HomeContent> {
  ...
  Widget build(BuildContext context) {
    ...
    final double progressValue = (exercise['repsCompleted'] ?? 0) / (exercise['repsTotal'] ?? 1);
    return Padding(
    ...
    children: [
    TextSpan(
    text: "${exercise['estimatedTimeMin'] ?? 0}",
    style: const TextStyle(
    fontWeight: FontWeight.bold,
    color: Color(0xFF1C1F2E),
    ),
    ...
    decoration: BoxDecoration(
    gradient: const LinearGradient(
    colors: [Color(0xFF5C9DED), Color(0xFF4A90E2)],
    ),
    ...
    child: const Text("No exercises assigned for today.", style: TextStyle(color: Colors.grey))
    ),
    ...
    const Center(
    child: Text("No reminders for now.", style: TextStyle(color: Colors.grey))
    ),
    ],
    ),
    ),
    ...
    const Center(child: Text('No upcoming appointments', style: TextStyle(color: Colors.grey))),
    ],
    ),
    ),
